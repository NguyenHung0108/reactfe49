...
export default class BaiTapQLSP extends Component {
    ...
    // -Nơi chưa control (nút nhấn ) làm thay đổi giá trị của state đó (trực tiếp hoặc gián tiếp)


    state = {
        sanPhamChiTiet: { "maSP": 2, "tenSP": "Meizu 16Xs", "manHinh": "AMOLED, FHD+ 2232 x 1080 pixels", "heDieuHanh": "Android 9.0 (Pie); Flyme", "cameraTruoc": "20 MP", "cameraSau": "Chính 48 MP & Phụ 8 MP, 5 MP", "ram": "4 GB", "rom": "64 GB", "gia": 7600000, "hinhAnh": "./img/dt1.jpg" }
    }
